...
df = pd.read_csv('tactic.csv') #Read Triplelift Tactic Mapping in CSV Format
...
for index, row in clean_df.iterrows():
	impression_pixels = eval(row['impression_pixel_json']) #convert values from impression_pixel_json as string to array 
