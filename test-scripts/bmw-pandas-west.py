...
df = pd.read_csv('../dataSources/west/BMW_WEST_dataFeed-06.13.csv')
df.set_index('unique_id', inplace=True)
#print(df[df['CTA_fontSize'] == '8px'])
dfcopydoc = pd.read_csv('../dataSources/west/new_regional_bmw_west_copydoc-v2.csv')
dfUrls = pd.read_csv('../dataSources/west/new_regional_bmw_west_urls.csv')
...
df.to_csv('../dataSources/west/BMW_WEST_dataFeedUpdate-'+today_timestamp+'.csv', sep=',')
